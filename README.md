...
Welcome to the Workforce-Distribution! This archive contains valuable insights and visualizations derived from an voluminous HR dataset spanning from 2000 to 2020, with over 22,000 rows. The data was meticulously cleaned and analyzed using PostgreSQL, transposed on Notepad++, and the results are beautifully visualized with Power BI. This comprehensive dashboard aims to answer crucial HR-related questions and shed light on various aspects of the organization's workforce.
